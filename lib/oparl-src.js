...
(function (window, document) {
	...
	OParl.Util = {
		...
		callObjectParser: function (callback) {
			if (this.data === null) {
				callback(null, null);
			} else if ((Object.prototype.toString.call(this.data) === '[object Array]') && (this.data.length === 1)) {
				OParl.Util.callParser(this.data[0].type, this.data[0], callback);
...
//		obj.deleted = json.deleted || false;
	 ...
	 */
	OParl.Util.registerNamespace('https://schema.oparl.org/1.0/Person', function (json, callback) {
		var obj = {};
...
//		obj.deleted = json.deleted || false;
	 ...
	 */
	OParl.Util.registerNamespace('https://schema.oparl.org/1.0/Membership', function (json, callback) {
		var obj = {};
...
//		obj.web = json.web || '';
	 ...
	 */
	OParl.Util.registerNamespace('https://schema.oparl.org/1.0/Location', function (json, callback) {
		var obj = {};
...
//		obj.deleted = json.deleted || false;
	 ...
	 */
	OParl.Util.registerNamespace('https://schema.oparl.org/1.0/AgendaItem', function (json, callback) {
		var obj = {};
...
//		obj.web = json.web || '';
	 ...
	 */
	OParl.Util.registerNamespace('https://schema.oparl.org/1.0/Consultation', function (json, callback) {
		var obj = {};
